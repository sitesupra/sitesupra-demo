...
Use your name and email address instead sample values in the example. After the command is executed the user will be created and approval email will be sent. Inside the email message will be a link. Following the link the new account password can be set. Make sure the link contains correct domain name where the SiteSupra is installed. Otherwise modify the relevant supra.ini configuration.
