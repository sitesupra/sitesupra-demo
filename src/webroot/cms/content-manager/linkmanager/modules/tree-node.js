...
YUI.add('website.sitemap-linkmanager-node', function (Y) {
	...
	Y.extend(LinkMapTreeNode, Supra.TreeNode, {
		CONTENT_TEMPLATE: '<div class="tree-node">\
			  					<div><span class="toggle hidden"></span><span class="remove"></span><span class="img"><img src="/cms/lib/supra/img/tree/none.png" /></span> <label></label></div>\
			  				</div>\
