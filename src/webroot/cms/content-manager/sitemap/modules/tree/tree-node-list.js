		...
		*/
		...
		'_createPanel': function () {
			...
			widgets.datagrid = datagrid = new Supra.DataGrid({
				...
				'dataColumns': [
					{'id': 'id'}, {'id': 'master_id'}, {'id': 'icon'}, {'id': 'preview'}, {'id': 'template'}, {'id': 'global'}, {'id': 'global_disabled'}, {'id': 'full_path'}, {'id': 'type'}, {'id': 'unpublished_draft'}, {'id': 'published'}, {'id': 'path'}, {'id': 'basePath'}
				],
				'columns': [
					{
						'id': 'date',
