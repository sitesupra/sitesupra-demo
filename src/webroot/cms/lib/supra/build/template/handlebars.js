...
YUI.add('supra.template-handlebars', function (Y) {
...
var Handlebars = Supra.Handlebars = {};
...
(function() {
  ...
  Handlebars.AST.StringNode = function(v) {
    this.type = "STRING";
    this.string = v;
  };

  Handlebars.AST.IntegerNode = function(v) {
    this.type = "INTEGER";
    this.integer = v;
  };

  Handlebars.AST.BooleanNode = function(v) {
    this.type = "BOOLEAN";
    this['boolean'] = v;
  };

  Handlebars.AST.CommentNode = function(v) {
    this.type = "comment";
    this.comment = v;
  };
...
(function(Compiler, JavaScriptCompiler) {
  ...
  JavaScriptCompiler.prototype = {
    ...
    nameLookup: function(parent, name, type) {
      if(JavaScriptCompiler.RESERVED_WORDS[name] || name.indexOf('-') !== -1 || !isNaN(name.substr(0,1))) {
        return parent + "['" + name + "']";
