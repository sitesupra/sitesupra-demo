		...
		'get': function (options) {
			...
			if (!(id in this.instances)) {
				...
				this.instances[id] = new this.Data({
					'viewURI': action.getDataPath(prefix + 'view'),
					'listURI': action.getDataPath(prefix + 'list'),
					'saveURI': action.getDataPath(prefix + 'save'),
					'moveURI': action.getDataPath(prefix + 'move'),
					'deleteURI': action.getDataPath(prefix + 'delete'),
					'insertURI': action.getDataPath(prefix + 'insert'),
					'imageRotateURI': action.getDataPath(prefix + 'imagerotate'),
					'imageCropURI': action.getDataPath(prefix + 'imagecrop'),
					'downloadURI': Manager.Loader.getDynamicPath() + Manager.Loader.getActionBasePath(actionName) + '/' + prefix + 'download',
