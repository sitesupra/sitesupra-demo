 ...
 */
class SupraControllerPagesEntityRevisionDataProxy extends \Supra\Controller\Pages\Entity\RevisionData implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'created', 'userId', 'id');
    }
