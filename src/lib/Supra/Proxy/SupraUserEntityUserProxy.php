 ...
 */
class SupraUserEntityUserProxy extends \Supra\User\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'name', 'creationTime', 'modificationTime', 'id', 'password', 'login', 'email', 'group', 'lastLoginTime', 'active', 'salt', 'sessionId');
    }
