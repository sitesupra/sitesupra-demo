...
class SupraControllerPagesEntityPageLocalizationProxy extends \Supra\Controller\Pages\Entity\PageLocalization implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'locale', 'title', 'master', 'blockProperties', 'id', 'template', 'path', 'pathPart', 'metaDescription', 'metaKeywords', 'active', 'scheduleTime', 'redirect');
    }
