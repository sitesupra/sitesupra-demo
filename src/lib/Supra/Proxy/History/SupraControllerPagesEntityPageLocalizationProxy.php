...
class SupraControllerPagesEntityPageLocalizationProxy extends \Supra\Controller\Pages\Entity\PageLocalization implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'locale', 'title', 'master', 'blockProperties', 'id', 'revision', 'template', 'path', 'parentPath', 'pathPart', 'metaDescription', 'metaKeywords', 'active', 'scheduleTime', 'redirect', 'creationTime', 'creationYear', 'creationMonth', 'publishTimeSet');
    }
