 ...
 */
class SupraControllerPagesEntityGroupPageProxy extends \Supra\Controller\Pages\Entity\GroupPage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function persistLocalization(\Supra\Controller\Pages\Entity\GroupLocalization $localization)
    {
        $this->__load();
        return parent::persistLocalization($localization);
    }
    ...
    {
        return array('__isInitialized__', 'localizations', 'left', 'right', 'level', 'global', 'id', 'revision', 'placeHolders', 'title');
    }
