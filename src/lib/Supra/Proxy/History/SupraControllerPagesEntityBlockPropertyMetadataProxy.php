 ...
 */
class SupraControllerPagesEntityBlockPropertyMetadataProxy extends \Supra\Controller\Pages\Entity\BlockPropertyMetadata implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getBlockProperty();
    }
    ...
    {
        return array('__isInitialized__', 'name', 'blockProperty', 'referencedElement', 'id', 'revision');
    }
