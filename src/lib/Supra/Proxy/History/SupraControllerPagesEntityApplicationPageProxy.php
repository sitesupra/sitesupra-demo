 ...
 */
class SupraControllerPagesEntityApplicationPageProxy extends \Supra\Controller\Pages\Entity\ApplicationPage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setApplicationId($applicationId);
    }
    ...
    {
        return array('__isInitialized__', 'localizations', 'left', 'right', 'level', 'global', 'id', 'revision', 'placeHolders', 'applicationId');
    }
