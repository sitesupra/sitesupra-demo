...
//		}
	...
	/**
	 * Reset stored page path
	 * workaround for page duplicate action (path will be re-generated by PagePath Listener
	 * using pathPart)
	 * 
	 * NB FIXME Calling this method from actual duplicator sucks, cause one of 
	 * localization data clone usages is between locales, where the new locale 
	 * is set after actual duplication.
	 */
