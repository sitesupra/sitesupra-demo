...
class OrderProvider
{
    ...
    public function getOrderByPaymentEntity(PaymentEntity $paymentEntity)
    {
        ...
        if ($paymentEntity instanceof Transaction) {
            ...
            $order = $this->getRecurringOrderByRecurringPaymentTransaction($paymentEntity);
        } else {
     ...
     * @return RecurringOrder
     */
    protected function getRecurringOrderByRecurringPaymentTransaction(RecurringPaymentTransaction $transaction)
    {
        $recurringPayment = $transaction->getRecurringPayment();

        $order = $this->getRecurringOrderByRecurringPayment($recurringPayment);
