...
class Theme extends Entity implements ThemeInterface
{
	...
	/**
	 * @OneToMany(targetEntity="Supra\Package\Cms\Entity\Theme\Parameter\ThemeParameterAbstraction", mappedBy="theme", cascade={"all"}, orphanRemoval=true, indexBy="name")
	 * @var ArrayCollection
	 */
	 ...
	 * @return string
	 */
	public function getGeneratedCssFilename(ThemeParameterSet $parameterSet)
	{
