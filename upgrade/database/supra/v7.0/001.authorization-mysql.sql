...
CREATE TABLE acl_object_identities (
	id CHAR(40) NOT NULL, 
	parent_object_identity_id CHAR(40) DEFAULT NULL, 
	class_id CHAR(40) NOT NULL, 
...
CREATE TABLE acl_object_identity_ancestors (
	object_identity_id CHAR(40) NOT NULL, 
	ancestor_id CHAR(40) NOT NULL, 
...
CREATE TABLE acl_entries (
	id CHAR(40) NOT NULL, 
	class_id CHAR(40) NOT NULL, 
	object_identity_id CHAR(40) DEFAULT NULL, 
	security_identity_id CHAR(40) NOT NULL, 
	field_name VARCHAR(50) DEFAULT NULL, 
	ace_order SMALLINT UNSIGNED NOT NULL, 
	mask INT NOT NULL, granting TINYINT(1) NOT NULL, 
