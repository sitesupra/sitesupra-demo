/**
 * Watch for content changes made by CMS and trigger events
 * 
 * @version 1.0.5
 */
define(['jquery', 'frontend/app'], function ($) {
    ...
    $.refresh = {
    	 ...
    	 * @returns {Function} Normalized function
    	 */
    		...
    		for (; i<ii; i++) {
    			...
    			if (type === 'refresh') {
    				if (!node.data('refresh-event-triggered')) {
    					...
    					evt.name = namespace = node.data('refresh-event');
