YUI.add("supra.input-checkbox", function (Y) {
	...
	var TEMPLATE = '<div class="su-input-checkbox-bg" tabindex="0">\
	...
	Input.HTML_PARSER = {
		'backgroundNode': function (srcNode) {
			var node = (srcNode.test('input') ? srcNode.previous() : srcNode.one('.su-input-checkbox-bg'));
			return (node && node.hasClass('su-input-checkbox-bg') ? node : null);
		},
