	...
	Y.extend(Input, Supra.Input.BlockBackground, {
		...
		destructor: function () {
			if (this.widgets) {
				...
				if (widgets.buttonCustom) {
					widgets.buttonCustom.destroy(true);
				}
				if (widgets.buttonSet) {
					widgets.buttonSet.destroy(true);
				}
				if (widgets.buttonRemove) {
					widgets.buttonRemove.destroy(true);
				}
				if (widgets.buttonEdit) {
					widgets.buttonEdit.destroy(true);
				}
				if (widgets.imageResizer) {
					widgets.imageResizer.destroy(true);
				}
