	...
	Y.extend(Input, Supra.Input.Proto, {
		...
		renderAdvancedControlsUI: function (container) {
			var inputRepeat     = new Supra.Input.SelectList({
						...
						'values': [
							{"id": "no-repeat", "title": Supra.Intl.get(["inputs", "background", "repeat", "no-repeat"]), "icon": "/cms/lib/supra/img/sidebar/icons/background/select-list-large-no-repeat.png"},
							{"id": "repeat-x",  "title": Supra.Intl.get(["inputs", "background", "repeat", "repeat-x"]),  "icon": "/cms/lib/supra/img/sidebar/icons/background/select-list-large-repeat-x.png"},
							{"id": "repeat-y",  "title": Supra.Intl.get(["inputs", "background", "repeat", "repeat-y"]),  "icon": "/cms/lib/supra/img/sidebar/icons/background/select-list-large-repeat-y.png"},
							{"id": "repeat",    "title": Supra.Intl.get(["inputs", "background", "repeat", "repeat"]),    "icon": "/cms/lib/supra/img/sidebar/icons/background/select-list-large-repeat.png"}
							//{"id": "cover",     "title": Supra.Intl.get(["inputs", "background", "repeat", "cover"]),     "icon": "/cms/lib/supra/img/sidebar/icons/background/select-list-large-cover.png"}
						],
						'value': 'no-repeat',
						'style': 'large-icons'
					}),
				inputPosition   = new Supra.Input.SelectList({
						...
						'values': [
							{"id": "0% 0%",     "title": Supra.Intl.get(["inputs", "background", "position", "top_left"]),       "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/position-top-left.png"},
							{"id": "50% 0%",    "title": Supra.Intl.get(["inputs", "background", "position", "top_center"]),     "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/position-top-center.png"},
							{"id": "100% 0%",   "title": Supra.Intl.get(["inputs", "background", "position", "top_right"]),      "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/position-top-right.png"},
							{"id": "0% 50%",    "title": Supra.Intl.get(["inputs", "background", "position", "center_left"]),    "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/position-center-left.png"},
							{"id": "50% 50%",   "title": Supra.Intl.get(["inputs", "background", "position", "center_center"]),  "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/position-center-center.png"},
							{"id": "100% 50%",  "title": Supra.Intl.get(["inputs", "background", "position", "center_right"]),   "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/position-center-right.png"},
							{"id": "0% 100%",   "title": Supra.Intl.get(["inputs", "background", "position", "bottom_left"]),    "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/position-bottom-left.png"},
							{"id": "50% 100%",  "title": Supra.Intl.get(["inputs", "background", "position", "bottom_center"]),  "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/position-bottom-center.png"},
							{"id": "100% 100%", "title": Supra.Intl.get(["inputs", "background", "position", "bottom_right"]),   "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/position-bottom-right.png"}
						],
						'value': '0% 0%'
					}),
				inputAttachment =  new Supra.Input.SelectList({
						...
						'values': [
							{"id": "scroll", "title": Supra.Intl.get(["inputs", "background", "attachment", "scroll"]), "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/attachment-scroll.png"},
							{"id": "fixed",  "title": Supra.Intl.get(["inputs", "background", "attachment", "fixed"]),  "icon": "/cms/lib/supra/build/input/assets/skins/supra/block-background/attachment-fixed.png"}
						],
						'value': 'scroll'
					});
		...
		/**
		 * Update UI to be in sync with value
		 */
		_uiSync: function (value) {
			this._uiFrozen = true;
			
			var value = (value === undefined || value === null ? "" : value),
				has_image = (value && value.image && value.image.image),
				position = "",
				repeat = "",
				attachment = "";
		...
		_setValue: function (value) {
			...
			if (value && value.image && 'size_width' in value.image) {
				// Image resizer needs numbers to perform calculations
				value.image.size_width = parseInt(value.image.size_width, 10) || 0;
				value.image.size_height = parseInt(value.image.size_height, 10) || 0;
				value.image.crop_left = parseInt(value.image.crop_left, 10) || 0;
				value.image.crop_top = parseInt(value.image.crop_top, 10) || 0;
				value.image.crop_width = parseInt(value.image.crop_width, 10) || value.image.size_width;
				value.image.crop_height = parseInt(value.image.crop_height, 10) || value.image.size_height;
			}
