YUI.add('supra.input-media-inline', function (Y) {
	...
	Y.extend(Input, Supra.Input.Proto, {
		...
		renderContent: function (node, data) {
			...
			if (data && type == 'image') {
				var style = null,
					//html = '<img class="as-layer" src="' + this.get('blankImageUrl') + '" width="100%" height="220" style="background: #e5e5e5 url(/public/cms/supra/img/medialibrary/icon-broken-plain.png) 50% 50% no-repeat;" alt="" />';
