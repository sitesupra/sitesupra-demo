...
Supra.YUI_BASE.groups.supra.modules = {
	...
	// Combobox, standalone
	'supra.input-combobox': {
		path: 'input/combobox.js',
		requires: ['supra.input-proto', 'supra.input-string', 'supra.button', 'supra.input-plugin-autocomplete', 'supra.crud-configuration']
	},
	
	// Autocomplete widget
	'supra.input-plugin-autocomplete': {
		path: 'input/plugin-autocomplete.js',
		requires: ['supra.datalist']
	},
