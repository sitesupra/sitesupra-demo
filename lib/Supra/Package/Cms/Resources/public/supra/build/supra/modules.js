...
Supra.YUI_BASE.groups.supra.modules = {
	...
	'supra.base': {
		path: 'base/base.js',
		requires: ['base', 'node', 'node-event-html5']
	},
	...
	'supra.dom-screen': {
		path: 'dom/dom-screen.js'
	},
	'supra.dom-style': {
		path: 'dom/dom-style.js'
	},
	'supra.dom-style-reset': {
		path: 'dom/dom-style-reset.js'
	},
	...
	'supra.htmleditor': {
		...
		requires: [
			...
			'supra.htmleditor-plugin-history',
		...
		'supra.htmleditor-nodes': {
			path: 'htmleditor/htmleditor-nodes.js',
			requires: ['supra.htmleditor-base']
		},
		'supra.htmleditor-selection': {
		...
		/* Plugins */
		'supra.htmleditor-plugin-history': {
			path: 'htmleditor/plugins/plugin-history.js',
			requires: ['supra.htmleditor-base']
		},
		'supra.htmleditor-plugin-link': {
	...
	'supra.tree-multiselect': {
		path: 'tree/tree-multiselect.js',
		requires: ['supra.tree', 'supra.tree-node-multiselect']
	},
	'supra.tree-node': {
	...
	'supra.tree-node-multiselect': {
		path: 'tree/tree-node-multiselect.js',
		requires: ['supra.tree-node']
	},
	...
	'supra.input-collection': {
		path: 'input/collection.js',
		requires: ['supra.input-proto']
	},
	'supra.input-set': {
		path: 'input/set.js',
	...
	'supra.form-property-element-locator': {
		path: 'input/property-element-locator.js',
		requires: ['base']
	},
